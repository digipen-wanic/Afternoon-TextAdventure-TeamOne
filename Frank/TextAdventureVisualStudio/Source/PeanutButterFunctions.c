...
void PeanutButter_Use(CommandContext context, GameState* gameState, WorldData* worldData)
{
	...
	{
		printf("The dog doesn't like the creamy peanutbutter...\n");
	}
}
void PeanutButter_Combine(CommandContext context, GameState* gameState, WorldData* worldData)
{
	...
	gameState->inventory = ItemList_Add(gameState->inventory, CrunchyPeanutButter_Build());
...
{
	return Item_Create("peanut butter", "A small amount of peanut butter.", true, PeanutButter_Use, PeanutButter_Take, NULL, PeanutButter_Combine, NULL);
}
