...
CommandList* CreateCommandList()
{
	...
	*/
	...
	CommandList_Addshortcut(cmdListPtr, "h", HandleHelpCommand, true);
	...
	CommandList_Addshortcut(cmdListPtr, "q", HandleQuitCommand, true);
	...
	CommandList_Addshortcut(cmdListPtr, "d", HandleDropCommand, true);
	...
	CommandList_Addshortcut(cmdListPtr, "l", HandleLookCommand, true);
	...
	CommandList_Addshortcut(cmdListPtr, "i", HandleInventoryCommand, true);

	/* TODO REQUIRED: create the "go" command
	TODO BASIC: add a short alias "g" */
	CommandList_Add(cmdListPtr, "go", HandleGoCommand, true);
	CommandList_Addshortcut(cmdListPtr, "g", HandleGoCommand, true);
